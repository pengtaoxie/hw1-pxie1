...
/* First created by JCasGen Sat Sep 20 11:26:40 EDT 2014 */
 ...
 * Updated by JCasGen Sat Sep 20 16:49:42 EDT 2014
 * @generated */
public class EntityMention_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("EntityMention");
  ...
  public int getStart(int addr) {
      ...
      jcas.throwFeatMissing("start", "EntityMention");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "EntityMention");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "EntityMention");
